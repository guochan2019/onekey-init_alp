...
echo ""
info "下一步：安装具体服务 (URL 已含 gh-proxy.com 镜像前缀, 直连受限环境可用)"
info "  sh <(wget -qO- https://gh-proxy.com/https://raw.githubusercontent.com/guochan2019/onekey-tailscale_alp/main/onekey-tailscale_alp.sh)"
info "  sh <(wget -qO- https://gh-proxy.com/https://raw.githubusercontent.com/guochan2019/onekey-mosdns_alp/main/onekey-mosdns_alp.sh)"
info "  sh <(wget -qO- https://gh-proxy.com/https://raw.githubusercontent.com/guochan2019/onekey-frpc_alp/main/onekey-frpc_alp.sh)"
